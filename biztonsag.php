...
// ----- Fejléc védelem (CSP, clickjacking, XSS alapok) -----
if (!headers_sent()) {
  ...
  // Engedélyezzük a használt CDNk-et (Bootstrap/FontAwesome)
  // Ha más CDN-t bevezetsz (Google Fonts stb.), add hozzá itt.
  $csp = [
    "default-src 'self'",
...
// ----- HTML escape (idempotens) -----
if (!function_exists('e')) {
  function e($str){ return htmlspecialchars((string)$str, ENT_QUOTES, 'UTF-8'); }
}

// ----- Fehérlistás beolvasók (ALAP) -----
...
// ----- Visszafelé kompatibilis helper (lecseréli a régi get_param-ot) -----
if (!function_exists('get_param')) {
  // Alapeset: biztonságos szöveg mező (magyar ékezetekkel)
...
// ----- CSRF token segédek (később ráhúzható minden POST formra) -----
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($n > 10) { http_response_code(429); exit('Túl sok kérés.'); }
}
