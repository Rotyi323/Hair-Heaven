  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="hhNav">
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item"><a class="nav-link <?= ($activePage==='shop'?'active':'') ?>" href="/store.php">Áruház</a></li>
        <li class="nav-item"><a class="nav-link <?= ($activePage==='services'?'active':'') ?>" href="/services.php">Szolgáltatások</a></li>
      </ul>

      <ul class="navbar-nav ms-auto align-items-center">
        <li class="nav-item me-2">
          <a class="btn btn-outline-dark" href="/cart.php"><i class="fa-solid fa-bag-shopping"></i> Kosár</a>
        </li>
        ...
        <?php if ($isLogged): ?>
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li><a class="dropdown-item" href="/my-bookings.php">Foglalásaim</a></li>
              <li><a class="dropdown-item" href="/my-orders.php">Rendeléseim</a></li>
              <li><a class="dropdown-item" href="/my-treatments.php">Kezeléseim</a></li>
              ...
              <?php if (!empty($_SESSION['role']) && $_SESSION['role'] === 'owner'): ?>
                ...
                <li><a class="dropdown-item" href="/admin/treatments.php"><i class="fa-solid fa-heart-pulse me-1"></i> Kezelések</a></li>
              <?php endif; ?>
        ...
        <?php else: ?>
          <li class="nav-item me-2">
            <a class="btn btn-outline-dark" href="/login.php"><i class="fa-solid fa-right-to-bracket"></i> Bejelentkezés</a>
          </li>
          <li class="nav-item">
            <a class="btn btn-cta text-white" href="/register.php"><i class="fa-solid fa-user-plus"></i> Regisztráció</a>
          </li>
        <?php endif; ?>
      </ul>
    </div>
