...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (function_exists('csrf_verify')) {
    if (!csrf_verify())
      $errors[] = 'Biztonsági hiba (CSRF). Kérlek próbáld újra.';
  } else {
    $token = $_POST['_token'] ?? '';
          ...
          <form method="post" action="/register.php" novalidate>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="username" name="username" value="<?= e($username) ?>" required
                minlength="3" maxlength="100" pattern="[A-Za-z0-9._\- ÁÉÍÓÖŐÚÜŰáéíóöőúüű]+"
                placeholder="pl. Anna Kovács">
              <div class="form-text">Megengedett: betűk (ékezetes is), számok, pont, aláhúzás, kötőjel, szóköz. Legalább
                3 betű legyen benne.</div>
            </div>

            <div class="mb-3">
              <label for="email" class="form-label">E-mail cím</label>
              <input type="email" class="form-control" id="email" name="email" value="<?= e($email) ?>" required
                maxlength="190" placeholder="te@pelda.hu">
            </div>
            ...
            <div class="row g-3">
              <div class="col-12 col-md-6">
                ...
                <input type="password" class="form-control" id="password" name="password" required minlength="8"
                  maxlength="100" autocomplete="new-password" placeholder="Legalább 8 karakter">
              </div>
              <div class="col-12 col-md-6">
                <label for="password_confirm" class="form-label">Jelszó megerősítése</label>
                <input type="password" class="form-control" id="password_confirm" name="password_confirm" required
                  minlength="8" maxlength="100" autocomplete="new-password" placeholder="Írd be újra a jelszót">
              </div>
            </div>
