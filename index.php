<?php
// Hair Heaven - Főoldal (index.php) - teljes fájl
...
if (empty($profiles)) {
  $profiles = [
    ['id'=>1,'display_name'=>'Anna K.','avatar'=>'uploads/profiles/anna.jpg','bio'=>'Színkezelt haj, heti pakolás.','favorite_brand'=>"L'Oréal"],
...
<head>
  ...
  <style>
    ...
    .product-card{ border:0; border-radius:16px; overflow:hidden; background:#fff; box-shadow:0 10px 30px rgba(0,0,0,.06); transition:transform .2s ease, box-shadow .2s ease; }
    ...
    .fav-brand{ color:#7e3dbf; border:1px solid #e5d6ff; padding:.2rem .55rem; border-radius:999px; font-size:.8rem; background:#fff0; }
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="hhNav">
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <?php else: ?>
          <li class="nav-item">
            <a class="btn btn-sm btn-cta text-white" href="/belepes.php"><i class="fa-solid fa-right-to-bracket me-1"></i> Bejelentkezés</a>
          </li>
        <?php endif; ?>
      </ul>
    </div>
...
<section class="py-5" id="ajanlatok">
  <div class="container">
    <div class="d-flex align-items-end justify-content-between mb-3">
      ...
      <a class="btn btn-outline-dark btn-sm" href="/aruhaz.php">Összes termék <i class="fa-solid fa-arrow-right ms-1"></i></a>
    </div>
    <div class="row g-4">
...
<section class="py-5">
  <div class="container">
    <div class="d-flex align-items-end justify-content-between mb-3">
      ...
      <a class="btn btn-outline-dark btn-sm" href="/szolgaltatasok.php">Összes szolgáltatás <i class="fa-solid fa-arrow-right ms-1"></i></a>
    </div>
    <div class="row g-4">
...
<section class="py-5">
  <div class="container">
    <div class="d-flex align-items-end justify-content-between mb-3">
      ...
      <a class="btn btn-outline-dark btn-sm" href="/ugyfelek.php">Minden profil <i class="fa-solid fa-arrow-right ms-1"></i></a>
    </div>
    <div class="row g-4">
